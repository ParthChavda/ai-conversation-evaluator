...
class ConversationORM(Base):
    ...
    turns: Mapped[list["TurnORM"]] = relationship(back_populates="conversation", cascade="all, delete-orphan")
...
class FacetEvaluationORM(Base):
    ...
    evaluation_id: Mapped[str] = mapped_column(ForeignKey("evaluation_results.evaluation_id"), nullable=False, index=True)
